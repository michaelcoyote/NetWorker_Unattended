...
#
use vars qw($NSRSERVER $NSRADM $RTMP $DEBUG %options
@CLUSTERNODES  $TMPCMDFILE $TRUN $SID $BPOLICY $RPOLICY $POOL $SAVEGROUP); 
#
######
...
#
# The oracle sid YOu'll be backing up
$SID="test1";
#
...
backup command: save -I /nsr/savelists/$SID;
